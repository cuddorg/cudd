 ...
 *    Note: Timeout tests were removed because they caused sanitizer/valgrind
 *    failures without providing reliable coverage since operations complete
 *    too quickly on modern hardware.
 * 
...
// Constants for memory stress tests
