...
{ rank = same; "CONST NODES";
{ node [shape = box]; "0x3a9";
}
}
"  s0  " -> "0x426" [style = solid];
"  s1  " -> "0x428" [style = solid];
"  s2  " -> "0x42a" [style = solid];
"  c3  " -> "0x42b" [style = solid];
"0x42a" -> "0x429";
"0x42a" -> "0x429" [style = dotted];
"0x42b" -> "0x3b0";
"0x42b" -> "0x429" [style = dashed];
"0x3b0" -> "0x3a9";
"0x3b0" -> "0x3a9" [style = dotted];
"0x428" -> "0x427";
"0x428" -> "0x427" [style = dotted];
"0x429" -> "0x3e2";
"0x429" -> "0x427" [style = dashed];
"0x3e2" -> "0x3a9";
"0x3e2" -> "0x3a9" [style = dotted];
"0x426" -> "0x425";
"0x426" -> "0x425" [style = dotted];
"0x427" -> "0x401";
"0x427" -> "0x425" [style = dashed];
"0x401" -> "0x3a9";
"0x401" -> "0x3a9" [style = dotted];
"0x425" -> "0x3a9";
"0x425" -> "0x3a9" [style = dotted];
"0x3a9" [label = "1"];
}
...
"  lb  " -> "0x41e" [style = dotted];
"  ub  " -> "0x3e2" [style = solid];
"  f  " -> "0x41d" [style = solid];
"  primes  " -> "0x419" [style = solid];
"  lprime  " -> "0x419" [style = solid];
"0x41d" -> "0x41a";
"0x41d" -> "0x41c" [style = dashed];
"0x41e" -> "0x417";
"0x41e" -> "0x3a9" [style = dashed];
"0x419" -> "0x3e2";
"0x419" -> "0x3a9" [style = dotted];
"0x41c" -> "0x3d1";
"0x41c" -> "0x3a9" [style = dotted];
"0x41a" -> "0x3e2";
"0x41a" -> "0x417" [style = dotted];
"0x3d1" -> "0x3e2";
"0x3d1" -> "0x3a9" [style = dashed];
"0x417" -> "0x3a9";
"0x417" -> "0x3e2" [style = dotted];
"0x3e2" -> "0x3a9";
"0x3e2" -> "0x3a9" [style = dotted];
"0x3a9" [label = "1"];
}
